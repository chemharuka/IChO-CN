...
\providecommand{\tightlist}{%
	\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}} %reduce list parskip
...
\newpage
\mysection{第1题\  高分子水凝胶系统的药物输送}
\input{p1.tex}

\newpage
\mysection{第2题\  奥尔图石（黑琥珀）样品中总碳含量的测定}
\input{p2.tex}

\newpage
\mysection{第3题\  分光光度法测定络合物形成的平衡常数}
\input{p3.tex}
